 ...
 * @author Juan Pablo
 */
public class MovMag1Abajo extends Thread{
   ...
   public MovMag1Abajo(){
    ...
    public MovMag1Abajo(int cantidad, Tablero tablero){
    ...
    public void moverAbajo(int cantidad){
        ...
        if(comprobarfin()){
            ...
            tablero.matrizL[tablero.c][tablero.tam-1]=0;
            tablero.matrizG[tablero.c][tablero.tam-1].setIcon(null);
            ...
            try {
                ...
                if (tablero.matrizL[tablero.c][tablero.d]==7){
                    if (cantidad==1){
                       config.setVida1(config.getVida1()-1);
                       tablero.matrizL[tablero.c][tablero.d]=0;
                       tablero.matrizG[tablero.c][tablero.d].setBackground(Color.yellow);
                       tablero.repintar();

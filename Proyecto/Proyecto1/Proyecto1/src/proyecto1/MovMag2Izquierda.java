 ...
 * @author Juan Pablo
 */
public class MovMag2Izquierda extends Thread{
   ...
   public MovMag2Izquierda(){
        
    }
    
    public MovMag2Izquierda(int cantidad, Tablero tablero){
    ...
    public void moverIzquierda(int cantidad){
        ...
        if(comprobarfin()){
            ...
            tablero.matrizL[0][tablero.f]=0;
            tablero.matrizG[0][tablero.f].setIcon(null);

 ...
 * @author Juan Pablo
 */
public class MovPri2Derecha extends Thread{
   ...
   public MovPri2Derecha(){
        
    }
    
    public MovPri2Derecha(int cantidad, Tablero tablero){
    ...
    public void moverDerecha(int cantidad){
        ...
        if(comprobarfin()){
            ...
            tablero.matrizL[tablero.tam-1][tablero.y]=0;
            tablero.matrizG[tablero.tam-1][tablero.y].setIcon(null);
            ...
            int pos = tablero.matrizL[tablero.x+1][tablero.y];
            if(pos==1||pos==2||pos==3||pos==4||pos==5||pos==6){
                int i=rm.nextInt(2);
                   switch(i){
                       case 0: MovPri2Arriba moviarriba = new MovPri2Arriba(cantidad,tablero); moviarriba.start();
                           break;
                       case 1: MovPri2Abajo moviabajo = new MovPri2Abajo(cantidad,tablero); moviabajo.start();
                           break;
                   }
                }
                else{

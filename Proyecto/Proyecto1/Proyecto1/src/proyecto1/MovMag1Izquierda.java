 ...
 * @author Juan Pablo
 */
public class MovMag1Izquierda extends Thread{
   ...
   public MovMag1Izquierda(){
        
    }
    
    public MovMag1Izquierda(int cantidad, Tablero tablero){
    ...
    public void moverIzquierda(int cantidad){
        ...
        if(comprobarfin()){
            ...
            tablero.matrizL[0][tablero.d]=0;
            tablero.matrizG[0][tablero.d].setIcon(null);

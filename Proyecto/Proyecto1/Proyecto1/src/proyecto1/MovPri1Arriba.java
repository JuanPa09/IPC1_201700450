 ...
 * @author Juan Pablo
 */
public class MovPri1Arriba extends Thread{
   ...
   public MovPri1Arriba(){
        
    }
    
    public MovPri1Arriba(int cantidad, Tablero tablero){
    ...
    public void moverArriba(int cantidad){
        ...
        if(comprobarfin()){
            ...
            tablero.matrizL[tablero.g][0]=0;
            tablero.matrizG[tablero.g][0].setIcon(null);
